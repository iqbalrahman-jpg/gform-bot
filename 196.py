...
times = data_196.times
index = data_196.index
...
try:
    while times:
        time.sleep(2)
        kelamin = 4 if list_baru.kelamin[index] == 1 else 5

        umur = data.hitungUsia(6,8)
        pekerjaan = data_196.pekerjaan(umur)
        penghasilan = data_196.penghasilan(pekerjaan)
        ...
        data.polaJawab3(2, 2, soal[0], 5, bawah)
